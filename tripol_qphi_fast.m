function out = tripol_qphi_fast(im2, geom, optsIn)
%TRIPOL_QPHI_FAST Fast q-phi binning on the native detector grid.
%
%   out = tripol_qphi_fast(im2, geom, opts)
%
% The output fields match the tripol output used by aps_detector_core:
...
% phi window.
%
% Adi Natan , updated from older tripol code version.
...
out.meta.engine = 'tripol_qphi_fast';
end
